...
enum NetworkEnvironment: String {
    ...
    case developmentBaseUrl = "http://18.133.15.111/api/customer_api/"
            ...
            if UserDefaults.standard.object(forKey: "isUserLogin") != nil {
                ...
                if UserDefaults.standard.object(forKey: "isUserLogin") as? Bool == true {
                    ...
                    do {
                        ...
                        {
                            print("Header Key : \t\(["key": headerKey, "x-api-key": loginModelDetails.loginData.xApiKey])")
                            return ["key": headerKey, "x-api-key": loginModelDetails.loginData.xApiKey]
                        }
                        else
                        {
